# RapRadar - Proyecto Integrador Aplicaciones Móviles
**Materia:** Aplicaciones Móviles (Módulo 1)  
**Institución:** UNAJ  
**Alumno:** Felipe Da Silva Moreno  

Decidí encarar el proyecto con una **estructura simplificada** en un único archivo de lógica (`app.js`). 
---
